...
public class MyScanner {
    ...
    private final ArrayList<String> reservedWords = new ArrayList<>(
            List.of("ia_valoarea", "numar", "input", "null", "daca", "si", "mai_mare", "mai_mic", "afiseaza", "restul_impartirii", "egal", "termina_programul", "parcurge_numere", "radical", "adauga", "scade", "inmultire", "impartire", "parcurgere_caractere", "cat_timp", "sir", "caracter", "boolean")
    );
